#!/usr/bin/python3
"""represents unittests for city.py."""
...
class TestCity_instantiation(unittest.TestCase):
    """Unittest for trying instantiation of the City."""
...
class TestCity_save(unittest.TestCase):
    """Unittest for trying save method of the City."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittest for trying to_dict method of the City."""
